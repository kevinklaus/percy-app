...
import TopNavigationComponent from '../navigation/TopNavigation.component';

/**
 * Very simple component rendering the Privacy Policy
 * @namespace
 * @name privacy
 */
function PrivacyPolicy() {
  return (
    <div>
      <TopNavigationComponent showBackButton={true} />
      <p>Effective date: June 26, 2019</p>

      <p>
        Percy ("us", "we", or "our") operates the
        https://percy-app.herokuapp.com/ website and the Percy mobile
      ...
      <p>
        ...
        have associated with that data. Our Privacy Policy for Percy is created
      ...
      <p>Percy uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        Percy will take all steps reasonably necessary to ensure that your data
      ...
      <p>
        Percy may disclose your Personal Data in the good faith belief that such
        action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Percy</li>
        <li>
      ...
      <ul>
        <li>By email: romy219@gmail.com</li>
      </ul>
    </div>
  );
}
